...
local clear_list = {
    ...
    'wzx.application.boot.create_character_intent',
    'wzx.application.boot.boot_intent_store',
    'wzx.config.map_ids',
    'wzx.bootstrap.create_character_entry',
    'wzx.presentation.y3.level_switch',
