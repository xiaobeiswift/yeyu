-- Inventory schema validation helpers. Mirrors economy/character style.
...
local function invalid(schema_name, field, reason, details)
    ...
    return result_err(
        ...
        'error.inventory.schema_validation_failed',
        false,
        details
    )
end
...
local function content_id(schema_name, field, value, prefix)
...
local function dense_array(schema_name, field, value)
