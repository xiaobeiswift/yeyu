...
本目录将成为策划可写的唯一内容源；`wzx/config/generated` 和 Y3 物编映射都是生成物，禁止手工修改。

**已开工（卷一）**：任务 / 对话 / 世界 / 遭遇 / 奖励中间稿见 `chapter_01/README.md` 与 `wzx/config/content/**/chapter_01.lua`（非 generated）。  
Excel 管线与其余表族仍待填。
